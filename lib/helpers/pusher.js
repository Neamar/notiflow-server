 ...
 */
module.exports = function pushNotification(user, content, author, flow, special, cb) {
  if(!special) {
    special = false;
  }
  ...
  var message = {
    ...
    'data.mentioned': content.toLowerCase().indexOf(user.nick.toLowerCase()) !== -1,
    'data.private': flow.private,
