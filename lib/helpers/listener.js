 ...
 */
var isUserTagged = function isUserHighlighted(tag, message, user) {
  var id = user.id.toString();

  var userTags = message.tags.filter(function(messageTag) {
...
var createNotificationData = function createMessage(message, user, author, flow) {
  var data = {
    ...
    highlight:  isUserTagged(":highlight", message, user),
